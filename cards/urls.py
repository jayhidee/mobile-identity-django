...
from .views import Cardz, CardzD, CardzView, CardValidate, CardOTP, DownloadCard, DownloadDeleteCard, GenerateQRCode
...
urlpatterns = [
    ...
    path('create/<str:salted>/', GenerateQRCode.as_view()),
]
